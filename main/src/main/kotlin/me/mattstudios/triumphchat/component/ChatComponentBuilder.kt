...
class ChatComponentBuilder {
     ...
     */
    fun append(text: String, hover: List<String>, click: Click, player: Player): ChatComponentBuilder {
     ...
     */
    fun append(nodes: List<MessageNode>, hover: List<String>, click: Click, player: Player): ChatComponentBuilder {
